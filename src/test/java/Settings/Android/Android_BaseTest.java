...
public class Android_BaseTest extends TestBase {

    public Android_BaseTest(AppiumDriver driver){
        this.driver = driver;
    ...
    protected void assertCountElementsOnPage(By elementBy){
        ...
        Assertions.assertEquals(7 ,elements.stream().count(), "The number of articles does not match ");
    }
